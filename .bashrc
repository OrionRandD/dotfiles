...
alias emacsndft="emacs -f notdeft"                 # emacs gui notdeft buffer
alias emacsg="emacsclient -c"                      # emacsclient GUI
alias emacst="emacsclient -t"                      # emacsclient -terminal - used to be "emacs -nw"
alias semacst="sudo emacsclient -t"                # used to be "sudo emacs -nw"
alias emacsgnd="emacsclient -c -a emacs"           # emacsclient GUI with alternate non-daemon
alias emacscien='emacs -q -l ~/scimax/init.el'     # emacs science startkit
alias emacsv="emacs -Q"                            # emacs vanilla

# There is a script for emacspers-gui.sh - emacs personal GUI
# alias emacspers-gui="emacs --with-profile personal"

# There is a script for emacspers-Term.sh - emacs personal Terminal
# alias emacspers-Term="emacs -nw --with-profile personal"
...
alias vm='mv -uv'
alias cp='cp -urv'
# alias rsync="rsync -azvh --exclude='.git'"
...
alias youtube-fk="pipe-viewer -C"   # for youtube videos
alias xyoutube-fk='gtk-pipe-viewer'   # for youtube videos
...
## init script
## if activated, it will cause a loop 
## have to fix this
# init_cypher.sh
...
export PATH="/usr/local/bin:/usr/bin:/bin:/usr/local/games:/usr/games:$HOME/.cargo/bin/:$PATH"
export PATH="$HOME/.config/bspwm/:/snap/bin:/usr/local/n/versions/node/11.12.0/bin:$PATH"
export PATH="$HOME/bin:$HOME/go/bin:$HOME/.local/bin:$HOME/.local/npm/bin:$PATH"
export PATH="$HOME/.yarn/bin:$HOME/.config/yarn/global/node_modules/.bin:$PATH"
export PATH="$HOME/.kotlin-comp/kotlinc/bin:$PATH"
...
export GTK_IM_MODULE=bus
export XMODIFIERS=@im=ibus
export QT_IM_MODULE=ibus

# https://www.linuxuprising.com/2020/10/how-to-enable-predictive-typing-on-your.html
...
# rofi
# manage rofi options in
# "~/.config/rofi/config.rasi"
 
# note: you have to make a symlink of all your "~/bin" scripts to
# "/usr/local/bin/" - otherwise "rofi -show combi" does not find them
