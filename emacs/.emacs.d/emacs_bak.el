...
;; [[file:~/.emacs.d/emacs.org::*Org-ac%20-%20org-auto-complete][Org-ac - org-auto-complete:1]]
(require 'org)
(require 'org-ac)
(add-to-list 'auto-mode-alist '("\\.org\\'" . org-mode))
;; Org-ac - org-auto-complete:1 ends here
...
;; theme-looper
;; color-theme-modern
;; and use theme-looper to change emacs themes
...
;; [[file:~/.emacs.d/emacs.org::*PDF%20tools][PDF tools:1]]
...
;; [[file:~/.emacs.d/emacs.org::*Deft][Deft:1]]
...
;;   light
;; #+END_SRC
;; then you can hit C-c C-c to execute the code
...
;;	      (require 'evil-mu4e)
	    ...
	    ;; (setq mu4e-get-mail-command "mbsync ~/gmail")
		 ...
		 ;; (setq mu4e-get-mail-command "mbsync -a --verbose")
...
;; C-x C-m load-library RET ox-reveal
 ...
 (setq org-reveal-mathjax t)
    ...
    ;; To load Org-reveal, type “C-x C-m load-library”, then type “ox-reveal”.
