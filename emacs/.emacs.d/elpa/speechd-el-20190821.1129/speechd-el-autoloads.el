;;; speechd-el-autoloads.el --- automatically extracted autoloads
;;
;;; Code:
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "braille" '("braille-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "brltty" '("brltty-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "mmanager" '("mmanager-")))
...
\(fn TEXT &key (priority speechd-default-text-priority) SAY-IF-EMPTY)" t nil)
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "speechd" '("speechd-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "speechd-braille" '("speechd-braille-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "speechd-brltty" '("speechd-br")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "speechd-bug" '("speechd-bug-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "speechd-common" '("with-speechd-coding-protection" "speechd-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "speechd-compile" '("speechd-compile")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "speechd-out" '("speechd")))
...
Speechd-Speak mode is enabled in all buffers where
`(lambda nil (speechd-speak-mode 1))' would do it.
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "speechd-speak" '("speechd-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "speechd-ssip" '("speechd-ssip-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "speechd-version" '("speechd-version")))

;;;***

;;;### (autoloads nil nil ("speechd-el-pkg.el") (0 0 0 0))
