...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "keyword-search" '("keyword-search-get-query")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "keyword-search-extra" '("keyword-search-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "keyword-search-mad" '("keyword-search-")))
