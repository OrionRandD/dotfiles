...
Note: for removing a package, delete it from the init.el
      and from the org file, delete the build-cache.el file, delete it from the build and repos directories
...
*** initial-scratch-message
    ...
    M-x customize-variable RET initial-scratch-message
